...
function PaypalSeeklogo({fill, height= "1em", width= '"1em"', ...props}: Props) {
  return (
    <svg
      id="prefix__Layer_1"
      data-name="Layer 1"
    ...
    >
      <defs>
        <style>
          {
            ".prefix__cls-1,.prefix__cls-2{fill:#009ee3;fill-rule:evenodd}.prefix__cls-2{fill:#113984}"
          }
        </style>
      </defs>
      <path
        className="prefix__cls-1"
        d="M192.95 386.87h38.74c20.8 0 28.63 10.53 27.42 26-2 25.54-17.44 39.67-37.92 39.67h-10.34c-2.81 0-4.7 1.86-5.46 6.9l-4.39 29.3c-.29 1.9-1.29 3-2.79 3.15h-24.34c-2.29 0-3.1-1.75-2.5-5.54l14.84-93.93c.58-3.76 2.64-5.55 6.74-5.55z"
...
const MemoPaypalSeeklogo = React.memo(PaypalSeeklogo);
export default MemoPaypalSeeklogo;
